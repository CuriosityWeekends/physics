...
yv = 1  # Initial y velocity (m/s)
y = 0  # Initial y pos
yBloss = 0    # Amount of Yvelocity that gets refected on bounce (0-1)

xv = 1  # Initial x velocity
x = 0   # Initial x pos
zv = 0  #Initial z velocity
z = 0   #Initial z pos
xzBloss=0  # Amount of X & Z velocity that remains on bounce (0-1)
